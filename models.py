...
storage = FileSystemStorage(path=STATIC_FOLDER + '/img' + '/company')
...
class Company(Base):
    ...
    dop_photo_1 = Column(String, nullable=True)
    dop_photo_2 = Column(String, nullable=True)
    dop_photo_3 = Column(String, nullable=True)
    dop_photo_4 = Column(String, nullable=True)
    dop_photo_5 = Column(String, nullable=True)
